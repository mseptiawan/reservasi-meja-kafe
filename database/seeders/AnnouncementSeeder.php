...
class AnnouncementSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $announcements = [
            [
                'title' => 'Diskon Spesial  Akhir Pekan Potongan 20%',
                'content' => 'Nikmati akhir pekanmu di PesanMeja dengan promo diskon 20% untuk semua varian kopi espresso base. Berlaku setiap hari Sabtu dan Minggu mulai pukul 16:00 - 19:00 WIB. Jangan sampai kelewatan ya!',
                'type' => 'promo',
                'status' => 'published',
            ...
            [
                'title' => 'Live Acoustic Night: Bersenda di PesanMeja',
            ...
            [
                'title' => 'Pengumuman Pemenang Giveaway Foto  Cerita',
                'content' => 'Selamat kepada para pemenang kompetisi foto kreatif periode bulan ini. Hadiah berupa voucher free coffee selama satu minggu penuh dapat diklaim melalui kasir dengan menunjukkan profil akun terverifikasi Anda.',
                'type' => 'announcement',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Diberitahukan kepada seluruh staff PesanMeja untuk selalu menjaga kerapihan dan sterilisasi alat espresso machine pasca shift malam berakhir. Panduan kebersihan baru dapat diunduh di dashboard internal masing-masing.',
                'type' => 'info_internal',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Cicipi perpaduan manisnya pastry premium terbaru kami, Croissant Almond dan Cinnamon Roll, yang sangat cocok menemani segelas es kopi susu aren khas PesanMeja.',
                'type' => 'promo',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'PesanMeja berkolaborasi dengan @KreatifPalembang mengadakan kelas merajut santai pada hari Minggu besok. Biaya pendaftaran sudah termasuk benang, jarum, dan free signature drink.',
                'type' => 'event',
                'status' => 'published',
            ...
            [
                ...
                'content' => 'Menyambut libur hari raya keagamaan, PesanMeja akan mengalami sedikit penyesuaian jam operasional. Kami buka mulai pukul 13:00 WIB dan tutup lebih awal pada pukul 21:00 WIB.',
                'type' => 'announcement',
                'status' => 'published',

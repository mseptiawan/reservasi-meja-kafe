    ...
    <div class="min-h-[calc(100vh-200px)] flex items-center justify-center p-6">
        ...
        <form method="POST" action="{{ route('admin.announcements.update', $announcement->id) }}" enctype="multipart/form-data" 
            ...
            <div class="p-6 space-y-5">
                ...
                <!-- Baris 1: Judul, Tipe & Status (Rata & Seimbang) -->
                ...
                <!-- Baris 3: Banner Gambar dengan Layout Rata (Menggunakan Preview Gambar Lama) -->
                <div class="space-y-1.5">
    ...
    <script>
        function previewImage(event) {
            ...
            if (input.files && input.files[0]) {
                ...
                // Mengembalikan tampilan gambar asal dari storage jika pembatalan input terjadi
                @if($announcement->image)

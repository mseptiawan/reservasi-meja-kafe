    ...
    <div class="min-h-[calc(100vh-200px)] flex items-center justify-center p-6">
        ...
        <form action="{{ route('admin.tables.update', $table->id) }}" method="POST" enctype="multipart/form-data" 
            ...
            <div class="p-6 space-y-5">
                ...
                <!-- Baris 3: Upload Gambar dengan Preview Data Lama -->
                <div class="space-y-1.5">
                    <label class="text-xs font-semibold text-slate-700 tracking-wide uppercase">Foto / Visual Meja</label>
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                        ...
                        <div class="md:col-span-3 space-y-1.5">
                            ...
                            <p class="text-[10px] text-slate-400">Format: JPG, JPEG, PNG, WEBP (Maksimal 2MB). Biarkan kosong jika tidak ingin mengubah gambar.</p>
                            @error('image')
                                <p class="text-[10px] text-rose-500 mt-1 font-medium">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <div class="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-end gap-2">
                ...
                <button type="submit" 
                    ...
                    <i class="fa-solid fa-floppy-disk mr-1.5 text-[10px]"></i> Simpan Perubahan
                </button>
            </div>
        </form>
    </div>
    ...
    <script>
        function previewImage(event) {
            ...
            if (input.files && input.files[0]) {
                ...
                // Mengembalikan ke gambar semula jika input dibersihkan
                @if($table->image)

<x-app-layout>
    ...
    <div class="text-[11px] text-slate-500 font-medium mb-3">
        Menampilkan filter area: <span class="text-slate-800 font-medium">"{{ $selectedArea }}"</span> ({{ $tables->count() }} Meja ditemukan)
    </div>
    @endif
            ...
            <div>
                <div class="relative h-48 bg-slate-50 overflow-hidden border-b border-slate-100">
                    ...
                    <div class="absolute top-3 right-3">
                        ...
                        @endphp
                        <span class="px-2.5 py-1 text-[9px] font-medium uppercase rounded-lg tracking-wider border {{ $statusClasses[$table->status] }}">
                ...
                <div class="p-4">
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <span class="px-2 py-0.5 text-[10px] font-medium text-slate-500 bg-slate-50 border border-slate-200/50 rounded-md">
                            {{ $table->area }}
                        </span>
                    </div>

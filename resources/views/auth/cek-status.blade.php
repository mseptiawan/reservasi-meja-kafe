...
<body class="antialiased min-h-screen bg-slate-50 flex items-center justify-center p-4 font-['Plus_Jakarta_Sans']">
    ...
    <div class="w-full max-w-md bg-white border border-slate-100 rounded-xl shadow-sm p-6 sm:p-8 space-y-6">
        ...
        <div class="p-4 bg-slate-50 border border-slate-100 rounded-lg space-y-3">
            <div class="text-[11px] font-medium text-slate-400 uppercase tracking-wider border-b border-slate-200/60 pb-1.5">Hasil Pencarian</div>
            ...
            <div class="grid grid-cols-3 gap-y-2 text-xs">
                ...
                <span class="col-span-2 flex items-center gap-1">
                    ...
                    <span class="px-2 py-0.5 rounded bg-amber-50 text-amber-700 border border-amber-200 font-medium text-[10px] uppercase">
                    ...
                    <span class="px-2 py-0.5 rounded bg-emerald-50 text-emerald-700 border border-emerald-200 font-medium text-[10px] uppercase">
                        <i class="fa-solid fa-circle-check text-[9px] mr-0.5"></i> Aktif (Silakan Login)
                    </span>
                    @else
                    <span class="px-2 py-0.5 rounded bg-rose-50 text-rose-700 border border-rose-200 font-medium text-[10px] uppercase">

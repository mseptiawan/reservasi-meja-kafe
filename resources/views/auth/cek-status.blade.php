...
<body class="antialiased min-h-screen bg-slate-50 flex items-center justify-center p-4 font-['Plus_Jakarta_Sans']">
    ...
    <div class="w-full max-w-md bg-white border border-slate-100 rounded-xl shadow-sm p-6 sm:p-8 space-y-6">
        ...
        <div class="text-center space-y-2">
            ...
            <p class="text-xs text-slate-400 font-medium">Masukkan Email atau Kode Customer Anda untuk melihat progres verifikasi.</p>
        </div>
        ...
        <form method="POST" action="{{ route('account.status.check') }}" class="space-y-3.5">
            ...
            <div class="space-y-1.5">
                <label for="search_key" class="text-[11px] font-semibold text-slate-600 tracking-wide uppercase">Email / Customer Code</label>
                <div class="relative">
                    ...
                    <input id="search_key" 
                           ...
                           required 
                           placeholder="e.g. CS-2026xxxx atau nama@email.com" 
        ...
        <!-- Footer Menu Pintas -->
        <div class="text-center text-[11px] text-slate-500 font-medium pt-3 border-t border-slate-100 flex justify-between items-center">
            <a href="{{ route('login') }}" class="text-indigo-600 hover:text-indigo-700 transition-colors">
                <i class="fa-solid fa-arrow-left text-[9px] mr-1"></i> Kembali ke Login
            </a>
            <a href="{{ route('register') }}" class="text-indigo-600 hover:text-indigo-700 transition-colors">
                Daftar Akun Baru
            </a>
        </div>

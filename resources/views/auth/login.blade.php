    ...
    <div class="flex w-full min-h-screen">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-between p-8 sm:p-16 bg-white">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <span class="font-medium text-slate-800 text-base tracking-tight">Senja Space</span>
            </div>
            ...
            <div class="w-full max-w-md mx-auto my-auto py-10">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between text-xs font-medium text-slate-500 px-0.5">
                        <label for="remember_me" class="inline-flex items-center cursor-pointer hover:text-slate-800 transition-colors">
                            <input id="remember_me" type="checkbox" class="rounded border-slate-300 text-indigo-600 focus:ring-indigo-500 w-4 h-4 mr-2" name="remember">
                            <span>Remember for 30 days</span>
                        </label>

                        @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-indigo-600 hover:text-indigo-700 transition-colors underline underline-offset-2">
                            Forgot password
                        </a>
                        @endif
                    </div>
                ...
                <div class="text-center mt-6 text-xs text-slate-500 font-medium">
                    ...
                    <a href="{{ route('register') }}" class="text-indigo-600 hover:text-indigo-700 font-medium transition-colors underline underline-offset-2">
                        Sign up
                    </a>
                </div>
            </div>
        ...
        <div class="hidden lg:flex w-1/2 bg-gradient-to-br from-indigo-50 to-indigo-100 items-center justify-center relative p-16 overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col items-center justify-center text-center space-y-8 max-w-lg">
                ...
                <div class="space-y-3">
                    <h3 class="text-xl font-medium text-slate-800">Seduh Harimu di Senja Space</h3>

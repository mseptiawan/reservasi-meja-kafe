    ...
    <div class="flex w-full min-h-screen">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-between p-6 sm:p-12 bg-white">
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="font-medium text-slate-800 text-sm tracking-tight">Senja Space</span>
            </div>
            ...
            <div class="w-full max-w-sm mx-auto my-auto py-4">
                ...
                @if (session('success'))
                <div class="mb-4 p-3 bg-emerald-50 border border-emerald-100 rounded-lg text-emerald-800 text-xs font-medium">
                    {{ session('success') }}
                </div>
                @endif
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-3.5">
                    ...
                    <!-- Input Nama Lengkap -->
                    <div class="space-y-1">
                        <label for="name" class="text-[11px] font-semibold text-slate-600 tracking-wide uppercase">Full Name</label>
                        <input id="name"
                            type="text"
                            name="name"
                            value="{{ old('name') }}"
                    ...
                    <!-- Input Email -->
                    <div class="space-y-1">
                        <label for="email" class="text-[11px] font-semibold text-slate-600 tracking-wide uppercase">Email address</label>
                        <input id="email"
                            type="email"
                            name="email"
                            value="{{ old('email') }}"
                    ...
                    <!-- Input Nomor Telepon -->
                    <div class="space-y-1">
                        <label for="phone_number" class="text-[11px] font-semibold text-slate-600 tracking-wide uppercase">Phone Number</label>
                    ...
                    <!-- Input Password -->
                    <div class="space-y-1">
                        <label for="password" class="text-[11px] font-semibold text-slate-600 tracking-wide uppercase">Password</label>
                        <input id="password"
                            type="password"
                            name="password"
                            required
                    ...
                    <div class="space-y-1">
                        <label for="password_confirmation" class="text-[11px] font-semibold text-slate-600 tracking-wide uppercase">Confirm Password</label>
                ...
                <div class="text-center mt-5 text-[11px] text-slate-500 font-medium space-y-3">
                    <div>
                        Already registered?
                        <a href="{{ route('login') }}" class="text-indigo-600 hover:text-indigo-700 font-medium transition-colors underline underline-offset-2">
                            Sign in
                        </a>
                    </div>
                    ...
                    <div class="pt-5 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-center gap-1">
                        ...
                        <a href="{{ route('account.status') }}" class="text-purple-600 hover:text-purple-700 font-medium transition-colors inline-flex items-center gap-0.5">
        ...
        <div class="hidden lg:flex w-1/2 bg-gradient-to-br from-indigo-50 to-indigo-100 items-center justify-center relative p-12 overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col items-center justify-center text-center space-y-6 max-w-sm">
                <div class="w-56 h-56 rounded-2xl bg-white/80 backdrop-blur-md border border-white/40 flex items-center justify-center shadow-lg shadow-indigo-100/30">
                    <i class="fa-solid fa-mug-hot text-5xl text-indigo-500"></i>
                </div>
                <div class="space-y-2">
                    <h3 class="text-lg font-medium text-slate-800">Seduh Harimu di Senja Space</h3>
                    <p class="text-xs text-slate-500 leading-relaxed max-w-xs">Temukan ruang kerja ternyaman, nikmati kopi hangat terbaik, dan amankan meja reservasi Anda dengan mudah.</p>
                </div>
            </div>

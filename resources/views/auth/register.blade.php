...
<body class="antialiased min-h-screen bg-white flex font-['Plus_Jakarta_Sans'] selection:bg-indigo-500 selection:text-white">
    ...
    <div class="flex w-full min-h-screen">
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-between p-6 sm:p-12 bg-white">
            ...
            <!-- Form Container (Dibuat lebih compact dengan max-w-sm dan py-4) -->
            <div class="w-full max-w-sm mx-auto my-auto py-4">
                ...
                <!-- Notifikasi Jika Berhasil Mendaftar -->
                @if (session('success'))
                ...
                <!-- Space-y disesuaikan menjadi 3.5 agar jarak antar form lebih rapat/compact -->
        ...
        <div class="hidden lg:flex w-1/2 bg-gradient-to-br from-indigo-50 to-indigo-100 items-center justify-center relative p-12 overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col items-center justify-center text-center space-y-6 max-w-sm">
                <!-- Radius box diubah ke rounded-2xl agar tidak terlalu bulat melengkung extreme -->
                ...
                <div class="space-y-2">
                    <h3 class="text-lg font-bold text-slate-800">Seduh Harimu di Senja Space</h3>
